...
public class DatagenGlobals {
    ...
    private static void registerSlabs(){
        ...
        SLABS.put(Blocks.CRACKED_NETHER_BRICKS, ModSlabs.CRACKED_NETHER_BRICKS_SLAB);
        SLABS.put(Blocks.CHISELED_NETHER_BRICKS, ModSlabs.CHISELED_NETHER_BRICKS_SLAB);
    ...
    private static void registerStairs(){
        ...
        STAIRS.put(Blocks.CHISELED_STONE_BRICKS, ModStairs.CHISELED_STONE_BRICKS_STAIRS);
        ...
        STAIRS.put(Blocks.CRACKED_NETHER_BRICKS, ModStairs.CRACKED_NETHER_BRICKS_STAIRS);
        STAIRS.put(Blocks.CHISELED_NETHER_BRICKS, ModStairs.CHISELED_NETHER_BRICKS_STAIRS);
    ...
    private static void registerWalls(){
        ...
        WALLS.put(Blocks.CHISELED_QUARTZ_BLOCK, ModWalls.CHISELED_QUARTZ_BLOCK_WALLS);
        WALLS.put(Blocks.QUARTZ_BRICKS, ModWalls.QUARTZ_BRICKS_WALLS);
        WALLS.put(Blocks.CRACKED_NETHER_BRICKS, ModWalls.CRACKED_NETHER_BRICKS_WALLS);
        WALLS.put(Blocks.CHISELED_NETHER_BRICKS, ModWalls.CHISELED_NETHER_BRICKS_WALLS);
